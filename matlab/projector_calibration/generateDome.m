function [h4]=generateDome(Rs,xsm,ysm,zsm, r,xOm,yOm,zOm, xP1o,yP1o,zP1o, x0,y0,x1,y1,x2,y2,h4)
...
%         fprintf(f,'%1.6f %1.6f %1.6f %1.6f %1.6f\n',azimAll(i,jj)/pi,elevAll(i,jj)/pi,(xVals(i,jj) - Xscale(1))./(Xscale(2) - Xscale(1)),(yVals(i,jj) - Yscale(1))./(Yscale(2) - Yscale(1)), 1);
%         fprintf(f,'%1.6f %1.6f %1.6f %1.6f %1.6f\n',azimAll(i,jj)/pi,elevAll(i,jj)/pi, (yVals(i,jj) - Yscale(1))./(Yscale(2) - Yscale(1)), (xVals(i,jj) - Xscale(1))./(Xscale(2) - Xscale(1)), 1);
        fprintf(f,'%1.6f %1.6f %1.6f %1.6f %1.6f\n', ...
