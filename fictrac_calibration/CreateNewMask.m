%CreateFilesForFicTrac checks if the last mask is correct, and if not - asks the
...
%Note: is CheckMask=0, the last modified *MASK* file in Calibration_Directory will be
